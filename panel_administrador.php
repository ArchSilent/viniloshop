      ...
      <div class="modal-body">
        <form action="" method="post">
            ...
            <div class="form-floating">
                ...
                <label for="floatingTextarea2">Descripcion breve del album</label>
            </div><br> 
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) { ?>
                <tr>
                        ...
                        <td>
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2<?php echo $row['id'] ?>">Editar</button>
                        ...
                        <div class="modal fade" id="exampleModal2<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                        ...
                                        <?php 
                                        // include('db/conexion.php');
                                        include("controllers/controller-editar_producto.php"); ?>
                                        <!-- Inputs modal agregar -->
                                         <input type="hidden" value="<?php echo $row['id'] ?>" name="txtid">
                                        <input type="text" class="form-control" name="nombreAc" placeholder="Nombre" value="<?php echo $row['nombre'] ?>"><br>
                                        <div class="form-floating">
                                            <textarea class="form-control" name="descripcionAc" placeholder="" id="floatingTextarea2" style="height: 100px"><?php echo $row['descripcion'] ?></textarea>
                                            <!-- <label for="floatingTextarea2"><?//php echo $row['descripcion'] ?></label> -->
                                        </div><br> 
                                        <input type="text" class="form-control" name="precioAC"value="<?php echo $row['precio'] ?>" placeholder="Precio"><br>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <button type="submit"  value="ok" name="btn-modificar" class="btn btn-primary">Guardar cambios</button>
                                </div>
                                    </form>
                                </div>
                            </div>
